#ifndef HIDL_GENERATED_VENDOR_SOMC_HARDWARE_CAMERA_CACAO_V3_1_BSCACAO_H
#define HIDL_GENERATED_VENDOR_SOMC_HARDWARE_CAMERA_CACAO_V3_1_BSCACAO_H
...
struct BsCacao : ICacao, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> getCapsV3_1(::vendor::somc::hardware::camera::cacao::V3_0::CameraIndex camIdx, getCapsV3_1_cb _hidl_cb) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::ICacao::getCapsV3_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&camIdx);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "vendor.somc.hardware.camera.cacao", "3.1", "ICacao", "getCapsV3_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getCapsV3_1(camIdx, [&](const auto &_hidl_out_caps, const auto &_hidl_out_err) {
            atrace_end(ATRACE_TAG_HAL);
            #ifdef __ANDROID_DEBUGGABLE__
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                ...
                _hidl_args.push_back((void *)&_hidl_out_err);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "vendor.somc.hardware.camera.cacao", "3.1", "ICacao", "getCapsV3_1", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_VENDOR_SOMC_HARDWARE_CAMERA_CACAO_V3_1_BSCACAO_H

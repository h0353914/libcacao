...
__attribute__((noinline, used))
s64
__gnu_ldivmod_helper(s64 n, s64 d, s64 *rem)
{
    *rem = n % d;
    return n / d;
}
...
__attribute__((noinline, used))
u64
__gnu_uldivmod_helper(u64 n, u64 d, u64 *rem)
{
    *rem = n % d;
    return n / d;
}
